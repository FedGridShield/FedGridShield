'''
Byzantine-robust federated learning with variance reduction and differential privacy (IEEE CNS 2023)
'''
import torch
...
def fedvrdp(local_updates, global_model, args, momentum=None, global_mask=None):
    ###########################
    ########## local ##########
    ###########################
    flat_local_updates = []
